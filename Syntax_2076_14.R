...
#
write.csv(a,"C:/Users/JULI YANDI RAHMAN/Downloads/Kerjaan/Project 2706/BBCA_01_b_250.csv")
...
a=cbind(VaR.garch.out,VaR.garch.out2)
#
write.csv(a,"C:/Users/JULI YANDI RAHMAN/Downloads/Kerjaan/Project 2706/BBRI_01_b_250.csv")
...
for (i in window:(TBMRI-1))
{
  ...
  spec.BMRI=ugarchspec(mean.model=list(armaOrder=c(2,2),include.mean=FALSE,external.regressors=NULL),
                       ...
                       distribution.model="norm")
  modelgarch.fit.BMRI=ugarchfit(spec=spec.BMRI,data=returnBMRI[(i-window+1):i],solver="hybrid")
  mean.garch = 0
...
S.garch2=Prof.garch/(TBMRI-window)
...
a=cbind(VaR.garch.out,VaR.garch.out2)
#
write.csv(a,"C:/Users/JULI YANDI RAHMAN/Downloads/Kerjaan/Project 2706/BMRI_01_b_250.csv")
...
for (i in window:(TBBNI-1)){
  ...
  spec.BBNI=ugarchspec(mean.model=list(armaOrder=c(2,2),include.mean=FALSE,external.regressors=NULL),
                       variance.model=list(garchOrder=c(1,6),external.regressors=bb),
                       distribution.model="norm")
  modelgarch.fit.BBNI=ugarchfit(spec=spec.BBNI,data=returnBBNI[(i-window+1):i],solver="gosolnp")
  mean.garch = 0
...
a=cbind(VaR.garch.out,VaR.garch.out2)
#
write.csv(a,"C:/Users/JULI YANDI RAHMAN/Downloads/Kerjaan/Project 2706/BBNI_01_b_250.csv")
